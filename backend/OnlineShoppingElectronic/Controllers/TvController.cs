...
namespace OnlineShoppingElectronic.Controllers
{
    ...
    public class TvController : Controller
    {
        ...
        public TvController(IConfiguration configuration, IWebHostEnvironment env)
        {
        ...
        {
            string query = @"
                    select TvId,TvName,TvBrand,TvUnit,TvPrice,TvDescription,TvPhoto from dbo.Tv";
        ...
        [HttpPost]
        public JsonResult Post(Tv t)
        {
            string query = @"
                   insert into dbo.Tv(TvName,TvBrand,TvUnit,TvPrice,TvDescription,TvPhoto) 
             values(
             '" + t.TvName + @"'
             ,'" + t.TvBrand + @"'
             ,'" + t.TvUnit + @"'
